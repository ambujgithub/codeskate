...
<?php 
	...
	// Check if user has registered through FB
	if($isfbuser!=1) {
...
<?php 
	...
	// User has logged into FB and needs to provide only a username and a password
	else {

?>

<section id="fb-register-form" style="padding-top: 90px;">
	<div class="container">
		<div class="row">
			<div class="col-sm-10 col-sm-offset-1 black-fg">
				<form class="form-horizontal font-bold fg-white" style="padding: 30px; background-color: #dd5050; border-radius: 3px;" method="post" id="frm-register-fb" action="inc/register_user">
					<fieldset>
						    <legend class="fg-white">Register with Codeskate <sup>&copy;</sup></legend>
						     <div class="form-group">
							      <label for="username" class="col-lg-3 control-label">Username : </label>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$(document).on('submit', '#frm-register-fb', function(event) {
