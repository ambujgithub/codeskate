...
// login helper with redlanguage_picker#_=_irect_uri
...
if ( isset( $session ) ) {
  ...
  $request = new FacebookRequest( $session, 'GET', '/me?fields=email,birthday,name' );
  ...
  header("Location: ../inc/fbregister.php");
} else {
