				...
				<div class="col-sm-12 black-fg">
					<div>
						...
						<table class="table-striped" width="100%">
							<tr>
								<th width="40%" style="text-align: center;">Elapsed time</th>
							...
							<?php while($row = mysqli_fetch_array($res)) :  ?>
									<tr>
										<td style="vertical-align: middle; padding: 20px; text-align: left;"><?php echo Server::time_elapsed_string('@'.$row['entry_timestamp'], true); ?></td>
